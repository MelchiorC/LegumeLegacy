...
public class FogManager : MonoBehaviour
{
    ...
    [Header("Fog Settings")]
    [Tooltip("Enable fog during rain")]
    public bool enableFogDuringRain = true;
    ...
    private void Update()
    {
        ...
        bool isRaining = enableFogDuringRain && weatherManager != null && weatherManager.IsRaining();
        
        bool shouldFogBeActive = isWithinFogTime || isRaining;
